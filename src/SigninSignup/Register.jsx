...
const name = form.name.value;
        ...
        const res = {name,email,password,image}
        console.log(res);
        ...
        <div>
            ...
            <div className="grid md:grid-cols-2 items-center gap-8 h-full">
                <div className="max-md:order-1 p-4">
                    <img 
                        src="https://i.ibb.co/jDjH1Tm/pexels-enric-cruz-lopez-6039193.jpg" 
                ...
                <div className="flex items-center md:p-8 p-6 bg-[#0C172C] h-full lg:w-11/12 lg:ml-auto">
                    ...
                    <form onSubmit={handlelogin} className="max-w-lg w-full mx-auto">
                        ...
                        <div className="mt-12">
                           <input type="submit" value="Registration" className="w-max shadow-xl py-2.5 px-8 text-sm font-semibold rounded-md bg-transparent text-yellow-400 border border-yellow-400 focus:outline-none"/>
