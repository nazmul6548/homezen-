...
const Form = ({handleSubmit}) => {
    return (
        <div>
             <form onSubmit={handleSubmit} className="mx-auto mt-8 bg-white rounded-lg py-6 px-4 shadow-md">
      <input
        type="text"
        name="property_title"
        required
      ...
      {/*  */}
       ...
       <input type="submit" value="Add Property" className="text-[#333] bg-green-200 hover:bg-green-300 font-semibold rounded-md text-sm px-6 py-3 block w-full mt-3"/>
