...
const ExtraSec = () => {
  ...
  <div className="grid sm:grid-cols-2 gap-6 max-sm:gap-12 py-12 px-6">
    ...
    <div className="text-center">
      <h3 className="font-bold text-4xl text-[#a8181f]">Special Offer</h3>
      <h6 className="text-2xl text-[#a8181f] mt-0.5">Limited Time Deal</h6>
      <p className="text-gray-800 text-base mt-4">Discover amazing discounts and deals. Don't miss out on our exclusive offers available for a limited time.</p>

      <button type="button" className="bg-gradient-to-r hover:bg-gradient-to-l from-[#a8181f] to-orange-600 hover:bg-orange-500 text-white tracking-wide font-semibold text-sm py-3 px-6 rounded-lg w-max mt-8">
        Shop Now
      </button>
    </div>
  </div>
