...
const LatestReviews = () => {
    ...
    return (
        <div className="my-4 font-[sans-serif] text-[#333] mt-16 mb-16">
  <div className="text-center max-w-xl mx-auto mb-12">
    ...
    <p className="text-sm mt-4 leading-relaxed">
      ...
      minim. Officia do aliqua.
    </p>
  </div>
  <div className="max-w-4xl mx-auto ">
   {
    reviews.map(review=>(
        <div key={review._id} className="grid md:grid-cols-2 items-center gap-8 max-w-4xl m-10">
        ...
        <div>
          ...
          <div className="mt-6">
            <p className="text-base font-semibold">Simon Konecki</p>
            <p className="text-xs text-gray-400">Founder of Labar</p>
          </div>
        </div>
      </div>
    ))
